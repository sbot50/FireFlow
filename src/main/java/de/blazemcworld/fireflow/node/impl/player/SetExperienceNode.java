...
public class SetExperienceNode extends Node {
    public SetExperienceNode() {
        ...
        NodeInput experience = input("Experience", NumberValue.INSTANCE);
        ...
        signal.setInstruction(new MultiInstruction(
                ...
                experience,
                new RawInstruction(Type.DOUBLE_TYPE, new LdcInsnNode(100.0)),
                new RawInstruction(Type.DOUBLE_TYPE, new InsnNode(Opcodes.DDIV)),
                new RawInstruction(Type.DOUBLE_TYPE, new LdcInsnNode(0.0)),
                new RawInstruction(Type.DOUBLE_TYPE, new LdcInsnNode(1.0)),
                ...
                new RawInstruction(Type.VOID_TYPE, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minestom/server/entity/Player", "setExp", "(F)V")),
