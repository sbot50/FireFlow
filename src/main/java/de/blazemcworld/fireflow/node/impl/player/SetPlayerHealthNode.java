...
public class SetPlayerHealthNode extends Node {
    public SetPlayerHealthNode() {
        ...
        NodeInput health = input("Health", NumberValue.INSTANCE);
        ...
        signal.setInstruction(new MultiInstruction(
                ...
                new RawInstruction(Type.VOID_TYPE, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minestom/server/entity/Player", "setHealth", "(F)V")),
