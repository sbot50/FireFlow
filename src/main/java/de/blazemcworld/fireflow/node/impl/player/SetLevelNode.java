...
public class SetLevelNode extends Node {
    public SetLevelNode() {
        ...
        NodeInput level = input("Level", NumberValue.INSTANCE);
        ...
        signal.setInstruction(new MultiInstruction(
                ...
                new RawInstruction(Type.VOID_TYPE, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minestom/server/entity/Player", "setLevel", "(I)V")),
